...
def result():
    my_canvas.create_text(800, 730, text="Most suitable crop is "+predict0(), font=("Times New Roman Bold", 40), fill="red")
...
button1 = Button(root, text="Predict", font=("Times New Roman", 25),command=result)
button1_window = my_canvas.create_window(750, 650, window=button1)
